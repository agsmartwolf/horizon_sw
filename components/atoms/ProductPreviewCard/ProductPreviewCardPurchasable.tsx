...
const ProductPreviewCardPurchasable: React.FC<ProductPreviewCardPurchasableProps> = ({
                                                                                         product,
                                                                                         fromPriceLabel = '',
    ...
    const containerClassNames =
        'relative flex flex-col gap-4 overflow-visible text-black lg:min-w-0 bg-gray-200 px-5 py-5 lg:px-10';
