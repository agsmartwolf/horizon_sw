...
const getCardClassName = (
  ...
  if (index === currentSlide) return 'left-0 z-10 opacity-100 bg-white';
...
const PressMentionCarousel: React.FC<PressMentionCarouselProps> = ({
  ...
  return (
    <section
      className={`${SECTION_MARGIN_MAP[horizontal_spacing]} relative flex flex-col items-center gap-y-10 bg-white lg:gap-y-[76px] lg:py-18`}>
